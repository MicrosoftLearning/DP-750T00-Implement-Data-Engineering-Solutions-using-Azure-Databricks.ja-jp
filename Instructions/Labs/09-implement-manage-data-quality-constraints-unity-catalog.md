...
このラボのすべての演習において、**Genie Code を使用することが想定されており、そうすることをおすすめします**。 すべての演習には、作業を開始するための推奨プロンプトが含まれています。 Genie Code はあなたとペアを組むプログラマーです。コードの生成、エラーの解釈、代替手段の調査にお使いください。
...
4. **[URL]** を選択し、次の URL を入力して **[インポート]** をクリックします。`https://raw.githubusercontent.com/MicrosoftLearning/DP-750T00-Implement-Data-Engineering-Solutions-using-Azure-Databricks/refs/heads/main/Allfiles/09-implement-manage-data-quality-constraints-unity-catalog.ipynb`
...
> 🤖 **Genie Code に質問する:**
>  *"PySpark で、withColumn と col().cast() を使用してストリーミング データフレーム列を STRING から DATE 型に変換し、もう 1 つの列を STRING から DECIMAL(12,2) に変換してください。完全な withColumn 構文を教えてください。"*
