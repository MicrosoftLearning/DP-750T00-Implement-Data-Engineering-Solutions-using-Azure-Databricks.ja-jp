...
このラボのすべての演習において、**Genie Code を使用することが想定されており、そうすることをおすすめします**。 すべてのノートブックのセルには、作業を始めるためのおすすめするプロンプトが含まれています。 Genie Code はあなたとペアを組むプログラマーです。コードの生成、エラー メッセージの説明、代替手段の調査、アプローチの検証にお使いください。
...
3. **[品質]** タブを選択し、**[有効]** を選択して **[データ品質の監視]** ダイアログを開きます。
4. **[データ プロファイル]** カードで、**[構成]** を選択して **[モニターの作成]** ダイアログを開きます。
5. **[プロファイル]** → **[プロファイルの種類]** で、**[スナップショット]** を選択します。これは、リストなどの汎用テーブルに適しています。
6. **[作成]** を選択してモニターを作成し、最初のプロファイルを生成します。
7. モニターが作成されたら、生成された **監視ダッシュボード** を開き ([品質] タブから **[ダッシュボードの表示]** を選択します)、**[更新]** を選択して設定します。 後でメトリックを再生成する必要がある場合は、[品質] タブに戻り、**[更新と最新の情報に更新]** を選択します。
8. 生成されたメトリックを調べます。 次を確認します。
