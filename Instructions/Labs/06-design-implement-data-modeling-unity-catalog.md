...
Genie Code を開くには、次をクリックします ![アシスタント アイコン](https://raw.githubusercontent.com/MicrosoftLearning/DP-750T00-Implement-Data-Engineering-Solutions-using-Azure-Databricks/refs/heads/main/Allfiles/media/genie-code.svg) をノートブック セルの右側でクリックするか、ツール バーに表示されているキーボード ショートカットを押します。
